...
To learn about querying from client-side applications using public endpoints, which do not require an API token, refer to the [Query with Public Endpoints](/ai-search/usage/public-endpoints/) guide.
